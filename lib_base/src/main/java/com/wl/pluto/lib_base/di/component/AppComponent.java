 ...
 */
package com.wl.pluto.lib_base.di.component;
...
import com.wl.pluto.lib_base.base.delegate.AppDelegate;
import com.wl.pluto.lib_base.di.module.AppModule;
import com.wl.pluto.lib_base.di.module.ClientModule;
import com.wl.pluto.lib_base.di.module.GlobalConfigModule;
import com.wl.pluto.lib_base.http.imageloader.BaseImageLoaderStrategy;
import com.wl.pluto.lib_base.http.imageloader.ImageLoader;
import com.wl.pluto.lib_base.integration.AppManager;
import com.wl.pluto.lib_base.integration.ConfigModule;
import com.wl.pluto.lib_base.integration.IRepositoryManager;
import com.wl.pluto.lib_base.integration.cache.Cache;
import com.wl.pluto.lib_base.utils.ArmsUtils;
 ...
 *
 * AppModule.class, ClientModule.class, GlobalConfigModule.class
 * ================================================
 */
@Singleton
...
public interface AppComponent {
    ...
    interface Builder {
        ...
        @BindsInstance
        AppComponent.Builder createApplication(Application application);

        AppComponent.Builder createGlobalConfigModule(GlobalConfigModule globalConfigModule);
