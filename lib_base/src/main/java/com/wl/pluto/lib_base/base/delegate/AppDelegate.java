 ...
 */
package com.wl.pluto.lib_base.base.delegate;
...
public class AppDelegate implements App, AppLifecycles {
    ...
    public void onCreate(@NonNull Application application) {
        ...
        mAppComponent = DaggerAppComponent
                .builder()
                .createApplication(mApplication)//提供application
                .createGlobalConfigModule(getGlobalConfigModule(mApplication, mModules))//全局配置
                .create();
    ...
    public AppComponent getAppComponent() {
        Preconditions.checkNotNull(mAppComponent,
                ...
                AppComponent.class.getName(), getClass().getName(), mApplication == null ? Application.class.getName() : mApplication.getClass().getName());
