package com.wl.pluto.module_component.view.popupwindows;
...
import com.wl.pluto.lib_kit.rxtool.RxDeviceTool;
...
public class RxPopupSingleView extends PopupWindow {
    ...
    public RxPopupSingleView(Context context, int width, int height) {
        ...
        // 获得屏幕的宽度和高度
        mScreenWidth = RxDeviceTool.getScreenWidth();
        mScreenHeight = RxDeviceTool.getScreenHeight();
        ...
        // 设置弹窗的布局界面
        setContentView(LayoutInflater.from(mContext).inflate(R.layout.popupwindow_layout, null));
    ...
    public void show(View view) {
        ...
        // 显示弹窗的位置
        showAtLocation(view, popupGravity, mScreenWidth - LIST_PADDING - (getWidth() / 2), mRect.bottom + RxSizeTool.dp2px(7.5f));
    }
