 ...
 */
package com.wl.pluto.andplout.app.utils;


import com.trello.rxlifecycle2.LifecycleTransformer;
import com.trello.rxlifecycle2.RxLifecycle;
import com.wl.pluto.lib_base.mvp.IView;
import com.wl.pluto.lib_base.utils.RxLifecycleUtils;
            ...
            public Observable<T> apply(Observable<T> observable) {
                return (Observable<T>) observable.subscribeOn(Schedulers.io())
                        .doOnSubscribe(new Consumer<Disposable>() {
                            @Override
                            public void accept(@NonNull Disposable disposable) throws Exception { view.showLoading();//显示进度条
                            }
                        })
                        ...
                        .doFinally(new Action() {
                            @Override
                            public void run() { view.hideLoading();//隐藏进度条
                            }
